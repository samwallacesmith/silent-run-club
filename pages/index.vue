  ...
  <div>
    ...
    >
      ...
      <div class="relative mx-auto max-w-5xl px-4 py-20 sm:px-6 sm:py-28">
        ...
        >
          For people who want to listen together, then actually talk after the
          miles.
        </h1>
        <p class="mt-6 max-w-2xl text-lg leading-relaxed text-zinc-300">
          ...
          on the sidewalk. When the run’s done, we head to the after-spot to
          debrief, laugh, meet the DJ, and keep the night going out loud.
        </p>
    ...
    <section v-if="nextEvent" class="mx-auto max-w-5xl px-4 py-16 sm:px-6">
      ...
      >
        ...
        <div v-if="nextJamQr" class="w-full max-w-sm shrink-0">
          <p
            class="mb-3 text-center text-xs font-medium uppercase tracking-wide text-zinc-500"
          >
            {{
    ...
    <section v-else class="mx-auto max-w-5xl px-4 py-16 sm:px-6">
      <p class="text-zinc-400">
        ...
        <code class="rounded bg-zinc-800 px-1.5 py-0.5 text-sm text-violet-300"
          >content/events/</code
        >.
      </p>
    </section>
    ...
    <section class="border-t border-zinc-800 bg-zinc-900/30">
      <div class="mx-auto max-w-5xl px-4 py-16 sm:px-6">
        ...
        <p class="mt-3 max-w-2xl text-zinc-400">
          Each run can spotlight a DJ—bios, socials, and mixes live on the site
          so the crowd knows who shaped the set.
        </p>
        <NuxtLink
          to="/djs"
